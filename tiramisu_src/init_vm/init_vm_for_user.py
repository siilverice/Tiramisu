...
if __name__ == "__main__":
	...
	c.execute("insert into cube (vm_name,latency_min,latency,latency_max,percentl,iops_min,iops,iops_max,percenti,cost_min,cost,cost_max,percentc,app_type) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"), (cube["name"],cube["latency_min"],cube["latency"],cube["latency_max"],cube["percentl"],cube["iops_min"],cube["iops"],cube["iops_max"],cube["percenti"],cube["cost_min"],cube["cost"],cube["cost_max"],cube["percentc"],cube["app_type"],))
